...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = ((letter.classList.item(0) == "valid") && (capital.classList.item(0) == "valid") && (number.classList.item(0) == "valid") && (match.classList.item(0) == "valid") && (length.classList.item(0) == "valid")); // TODO: Replace false with the correct condition
    if(condition) {       
