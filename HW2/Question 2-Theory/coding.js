function display2_1() {
  var myanswer  = "My answer goes here: 'undefined', 'True', 'False'.\n The first comparison is True because null and undefined have the same value, however the second is False because null has a type of 'object' while undefined has a type of 'undefined'"; // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "My answer goes here: The code written as is would produce an error because 'x' is undefined.\n If the 'use strict' were removed, then the script would run without error because it is no longer required that any variables be defined."; // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "My answer goes here: The children are displayed as none (or invisible) and so the HTML does not show them, however they still exist in the HTML code as tags."; // TODO 2.5: Fill in Answer here
