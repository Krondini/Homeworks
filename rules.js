...
function reset_play(){
	/* Part 1 */
	document.getElementById("player1_id").value = ""; //Changing the Text boxes back to original state
	...
	// console.log(document.getElementById("player1_id").value); //Testing changing values
	// console.log(document.getElementById("player2_id").value);
